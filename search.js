 ...
 const studentData = {
    ...
    },
    {
      "name": "Sophia Wilson",
      "enrollmentId": "EN004",
      "comfortableLanguage": "JavaScript",
      "collegeName": "GHI University",
  ...
  function searchStudents() {
    ...
    const filteredStudents = studentData.students.filter(student => {
      ...
      return (
        studentPreferredLang === preferredLanguage || studentSecondaryLang === secondaryLanguage
      );
    });
